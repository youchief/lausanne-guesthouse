...
(function() {
  ...
  (function($) {
    ...
    Calendar = function(element, options) {
      ...
      this.time = new Date();
      this.currentMonth = this.initialDraw();
      return null;
    };
    Calendar.prototype = {
      ...
      initialDraw: function() {
        ...
        return this.drawDays(time.year, time.month);
      },
      ...
      prev: function() {
        if (this.currentMonth - 1 < 0) {
          this.time.setYear(this.time.getFullYear() - 1);
          this.time.setMonth(11);
        } else {
          this.time.setMonth(this.currentMonth - 1);
        }
        this.currentMonth = this.drawDays(this.time.getFullYear(), this.time.getMonth());
        return null;
      },
      next: function() {
